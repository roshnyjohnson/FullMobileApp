  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `detections` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `zoneId` INTEGER NOT NULL, `crowdCount` INTEGER NOT NULL, `timestamp` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '556e8d833a02766fb370b64dd9e0f666')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsDetections.put("zoneId", new TableInfo.Column("zoneId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsDetections.put("crowdCount", new TableInfo.Column("crowdCount", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoDetections.equals(_existingDetections)) {
          return new RoomOpenHelper.ValidationResult(false, "detections(com.crowdcount.app.data.Detection).\n"
                  + " Expected:\n" + _infoDetections + "\n"
                  + " Found:\n" + _existingDetections);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "556e8d833a02766fb370b64dd9e0f666", "e384b072b1ab493dcd8255e82db478ca");
